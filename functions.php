...
// declare(strict_types=1); // duplicate block
...
add_action('acf/init', function (): void {
    // ACF calls guarded (as requested).
    if (!function_exists('get_field') || !function_exists('acf_add_local_field_group')) {
        return;
    }

    acf_add_local_field_group([
        'key' => 'group_respublica_article_fields',
        'title' => 'Res.Publica – Artikel-Felder',
        'fields' => [
            [
                'key' => 'field_respublica_breaking',
                'label' => 'Breaking',
                'name' => 'breaking',
                'type' => 'true_false',
                'ui' => 1,
            ...
            [
                'key' => 'field_respublica_pullquote_text',
                'label' => 'Pullquote Text',
                'name' => 'pullquote_text',
                'type' => 'textarea',
                'rows' => 3,
            ...
            [
                'key' => 'field_respublica_pullquote_attribution',
                'label' => 'Pullquote Attribution',
                'name' => 'pullquote_attribution',
                'type' => 'text',
            ],
            [
                'key' => 'field_respublica_factbox_items',
                'label' => 'Factbox Items',
                'name' => 'factbox_items',
                'type' => 'repeater',
                'min' => 0,
                ...
                'sub_fields' => [
                    [
                        'key' => 'field_respublica_factbox_item_text',
                        'label' => 'Punkt',
                        'name' => 'text',
                        'type' => 'text',
                    ],
